...
from tkinter import Tk, Frame, Button, Label, Canvas, Text, Toplevel, Menu, LabelFrame, Listbox
from tkinter.constants import E, W, N, LEFT, BOTH
import pickle
import time
import pygame
...
class MazeGUI:
    ...
    def start_menu_init(self):
        ...
        set_difficulty("Easy")
        set_category_button = Button(menu_spacer2, text="Category", font="Times 20",
                                    command=self.set_category())
        set_category_button.grid(row=5, column=1, columnspan=2, sticky=W)
    ...
    def set_category(self):
        return self.openNewWindow

    def openNewWindow(self):

        newwindow = Toplevel(self.root)
        newwindow.title("Category")
        newwindow.geometry("500x500")
        Label(newwindow, text="Category window").pack()
        listbox = Listbox(newwindow, height=50,
                          width=35,
                          bg="grey",
                          activestyle='dotbox',
                          font="Helvetica",
        ...
        categorylist = sqlDatabase.get_category_list()
        index = 1
        ...
        back_button = Button(newwindow, text="Back", command=self.screen_switch_from_Category(self.startmenu))

    def openNewWindow(self):

        newwindow = Toplevel(self.root)
        newwindow.title("Category types")
        newwindow.geometry("500x500")
        Label(newwindow, text="Category window").pack()
        listbox = Listbox(newwindow, height=50,
                          width=35,
        ...
        back_button = Button(newwindow, text="Back", command=self.screen_switch_from_Category(self.startmenu))
    def print_out_selection(self,text, categories):
    ...
    def add_time(self,start):
        ...
        submit = Button(gamescreen, text='Select', font='Times 20',
                        command=lambda:self.print_out_selection(n.get(),categories))
        submit.grid(row=1, column=0)
        start = int(time.time())
        timer_button = Button(gamescreen, text='Add Time', command=lambda: self.add_time(start))
    ...
    def screen_switch_from_Category(self, new_frame):
