...
class SQLDatabase:
    ...
    @staticmethod
    def get_que_of_perticular_category_list():
        """Queries the api for the categories and corresponding category id's. Converts that to a dictionary and returns
        it."""
        c_response = requests.get("https://opentdb.com/api.php?amount=50&category=9")
        category_type = c_response.json()
        category_que_list = {}
        return category_que_list
